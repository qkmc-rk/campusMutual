		...
		<div class="layui-fluid">
			...
			<div class="layui-row">
				...
				<div class="site-title">
			      <fieldset><legend><a name="use">发布求助信息</a></legend></fieldset>
			    </div>
			    	...
			    	<form class="layui-form" action="" method="post">
						<div class="layui-form-item layui-inline">
							...
							<div class="layui-input-block">
								<input type="text" name="neckname" required  lay-verify="required" value="" placeholder="请输入标题" autocomplete="off" class="layui-input">
							</div>
						</div><br />
						<div class="layui-form-item layui-inline">
							<label class="layui-form-label">截止时间</label>
							<div class="layui-input-block">
								<input type="text" name="timeout" class="layui-input" id="timeout">
								<script>
						...
						<div class="layui-form-item layui-inline">
							...
							<div class="layui-input-block">
								<input type="text" name="tip" required  lay-verify="required" placeholder="请输入备注" autocomplete="off" class="layui-input">
							</div>
						</div><br />
						<div class="layui-form-item layui-inline">
							<label class="layui-form-label">赏金</label>
							<div class="layui-input-block">
								<input type="number" name="reward" required  lay-verify="required" placeholder="请输入金额(元)" autocomplete="off" class="layui-input">
							</div>
						</div>
						<br />
						<div id="editor">
					        <p>在这里键入 <b>求助信息详情内容</b></p>
					        <p style="color:orange">(提示:为美观起见,可尽量将内容居中)</p> 
					        <script type="text/javascript">
					        	var E = window.wangEditor;
					        	var editor = new E('#editor');
					        	/*配置文件上传信息*/
					        	editor.customConfig.uploadImgServer = "/xx";
						...
						<div class="layui-form-item">
						    <div class="layui-input-block">
						      <button class="layui-btn publish-form-btn" lay-submit lay-filter="formDemo">发布任务</button>
						    </div>
						</div>
			    	</form>
			    </div>
